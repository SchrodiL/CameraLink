...
const char* camera_mode_to_string(camera_mode_t mode) {
    switch (mode) {
        case CAMERA_MODE_SLOW_MOTION:        return "慢动作 / Slow Motion";
        case CAMERA_MODE_NORMAL:             return "视频 / Video";
        case CAMERA_MODE_TIMELAPSE:          return "静止延时 / Timelapse";
        case CAMERA_MODE_PHOTO:              return "拍照 / Photo";
        case CAMERA_MODE_HYPERLAPSE:         return "运动延时 / Hyperlapse";
        case CAMERA_MODE_LIVE_STREAMING:     return "直播 / Live Streaming";
        case CAMERA_MODE_UVC_STREAMING:      return "UVC 直播 / UVC Live Streaming";
        case CAMERA_MODE_SUPERNIGHT:         return "低光视频（超级夜景）/ SuperNight";
        case CAMERA_MODE_SUBJECT_TRACKING:   return "人物跟随 / Subject Tracking";

        case CAMERA_MODE_PANORAMIC_VIDEO_360: return "全景视频 / Panoramic Video (Osmo360)";
        case CAMERA_MODE_HYPERLAPSE_360:      return "运动延时 / Hyperlapse (Osmo360)";
        case CAMERA_MODE_SELFIE_360:          return "自拍模式 / Selfie Mode (Osmo360)";
        case CAMERA_MODE_PANORAMIC_PHOTO_360: return "全景拍照 / Panoramic Photo (Osmo360)";
        case CAMERA_MODE_BOOST_VIDEO_360:     return "极广角视频 / Boost Video (Osmo360)";
        case CAMERA_MODE_VORTEX_360:          return "时空凝固 / Vortex (Osmo360)";
        case CAMERA_MODE_PANORAMIC_SUPERNIGHT_360: return "全景超级夜景 / 360° SuperNight (Osmo360)";
        case CAMERA_MODE_SINGLE_LENS_SUPERNIGHT_360: return "单镜头超级夜景 / Single Lens SuperNight (Osmo360)";

        default: return "未知模式 / Unknown mode";
    }
}

const char* camera_status_to_string(camera_status_t status) {
    switch (status) {
        case CAMERA_STATUS_SCREEN_OFF:          return "屏幕关闭 / Screen off";
        case CAMERA_STATUS_LIVE_STREAMING:      return "直播 / Live streaming (including screen-on without recording)";
        case CAMERA_STATUS_PLAYBACK:            return "回放 / Playback";
        case CAMERA_STATUS_PHOTO_OR_RECORDING:  return "拍照或录像中 / Photo or recording";
        case CAMERA_STATUS_PRE_RECORDING:       return "预录制中 / Pre-recording";
