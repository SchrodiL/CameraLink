...
extern uint8_t current_photo_ratio;
extern uint16_t current_real_time_countdown;
...
extern char current_product_id[17];
extern uint32_t current_camera_device_id;
extern uint8_t current_mode_param[20];
extern uint8_t current_mode_param_length;
extern uint8_t current_mode_name[20];
